  ...
  const [contents, setContents] = useState([
    {
      title: '정책1',
      content:
        '간단한 내용간단한 내용간단한 내용간단한 내용간단한 내용간단한 내용간단한 내용간단한 내용간단한 내용간단한 내용간단한 내용간단한 내용간단한 내용간단한 내용간단한 내용간단한 내용간단한 내용간단한 내용간단한 내용간단한 내용간단한 내용간단한 내용간단한 내용간단한 내용간단한 내용간단한 내용간단한 내용간단한 내용간단한 내용간단한 내용간단한 내용간단한 내용간단한 내용간단한 내용간단한 내용간단한 내용간단한 내용간단한 내용간단한 내용간간단단',
    },
    {
      title: '정책2',
      content: '카드 뉴스 내용 2',
  ...
  return (
    <div className='flex-col my-[30px]'>
      <input
        ...
        className='border-2 border-color-[#EAEAEA] rounded-lg p-2 mb-4'
      />
